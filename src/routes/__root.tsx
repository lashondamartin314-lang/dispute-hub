  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4 text-center">
      <div className="max-w-md">
        ...
        <a
          href="/"
          className="mt-6 inline-flex rounded-full bg-accent px-5 py-2 text-sm font-semibold text-accent-foreground"
        >
          Back to the Hub
        </a>
      </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "The Dispute Playbook · Credit Academy" },
      {
        name: "description",
        content:
          "Six phases. Five rounds. The interactive companion to the Credit Academy Dispute Playbook by Shonda Martin.",
      },
      ...
      { property: "og:title", content: "The Dispute Playbook · Credit Academy" },
      {
        ...
        content:
          "An interactive, editorial companion to the six-phase, five-round credit dispute kit.",
      },
          ...
          <div className="flex min-h-screen w-full bg-background">
            ...
            <SidebarInset className="bg-transparent">
              ...
              <footer className="border-t border-border/60 px-6 py-8 text-center text-xs text-muted-foreground">
                <p>
                  Educational only · Not legal advice. © {new Date().getFullYear()} Shonda Martin ·
                  Credit Academy.
                </p>
              </footer>
            </SidebarInset>
