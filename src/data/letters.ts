export type LetterId =
  ...
  | "L11" | "L12" | "L13" | "L14"
  | "L15A" | "L15B" | "L15C" | "L16" | "L17" | "L18" | "L19";

export type PhaseId = "prepare" | "validate" | "clean-identity" | "dispute-bureaus" | "challenge-furnishers" | "escalate";
...
export const LETTERS: Letter[] = [
  { id: "L01", phaseId: "validate", phaseNumber: 2,
  ...
  { id: "L02", phaseId: "validate", phaseNumber: 2,
  ...
  { id: "L03", phaseId: "validate", phaseNumber: 2,
  ...
  { id: "L04", phaseId: "validate", phaseNumber: 2,
  ...
  { id: "L05", phaseId: "clean-identity", phaseNumber: 3,
  ...
  { id: "L06", phaseId: "clean-identity", phaseNumber: 3,
  ...
  { id: "L07", phaseId: "clean-identity", phaseNumber: 3,
  ...
  { id: "L08", phaseId: "clean-identity", phaseNumber: 3,
  ...
  { id: "L09", phaseId: "clean-identity", phaseNumber: 3,
  ...
  { id: "L10", phaseId: "clean-identity", phaseNumber: 3,
  ...
  { id: "L11", phaseId: "dispute-bureaus", phaseNumber: 4,
  ...
  { id: "L12", phaseId: "dispute-bureaus", phaseNumber: 4,
  ...
  { id: "L13", phaseId: "dispute-bureaus", phaseNumber: 4,
  ...
  { id: "L14", phaseId: "dispute-bureaus", phaseNumber: 4,
  ...
  { id: "L15A", phaseId: "challenge-furnishers", phaseNumber: 5,
  ...
  { id: "L15B", phaseId: "challenge-furnishers", phaseNumber: 5,
  ...
  { id: "L15C", phaseId: "challenge-furnishers", phaseNumber: 5,
  ...
  { id: "L16", phaseId: "challenge-furnishers", phaseNumber: 5,
  ...
  { id: "L17", phaseId: "challenge-furnishers", phaseNumber: 5,
  ...
  { id: "L18", phaseId: "challenge-furnishers", phaseNumber: 5,
  ...
  { id: "L19", phaseId: "challenge-furnishers", phaseNumber: 5,
