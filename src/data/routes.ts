...
export type RefId =
  | "hub" | "playbook" | "foundation" | "strategy"
  | "phases-rounds" | "phase-map" | "round-strategy" | "account-router"
  | "round-tracker" | "letters" | "resources"
  | `phase-${PhaseId}` | `round-${1 | 2 | 3 | 4 | 5}`;
...
export const REFS: Record<RefId, RefTarget> = {
  ...
  "phase-clean-identity": { label: "Phase 3 · Clean Identity", to: "/playbook/phase/clean-identity" },
  "phase-dispute-bureaus": { label: "Phase 4 · Dispute Bureaus", to: "/playbook/phase/dispute-bureaus" },
  "phase-challenge-furnishers": { label: "Phase 5 · Challenge Furnishers", to: "/playbook/phase/challenge-furnishers" },
