      ...
      modules: [
        {
          ...
          walkthrough: [
            { step: "Go to AnnualCreditReport.com", detail: "This is the only federally-authorized free source. Not Credit Karma, not the bureau apps, not your bank's free score. Those are summaries — you need the full file." },
            { step: "Choose all three bureaus in one session", detail: "If you stagger the pulls by weeks, the data shifts under you and your audit becomes inconsistent." },
            { step: "Verify identity carefully", detail: "If a bureau locks you out, request a manual pull by mail with proof of identity (ID + utility bill). That mail-in request itself becomes part of your evidence trail." },
            { step: "Save PDFs immediately", detail: "Date-stamp each file: equifax-2026-05-14.pdf. You will reference these every round, and the bureaus quietly change reports between pulls." },
            { step: "Print or open side-by-side", detail: "You cannot work from one bureau at a time. Differences across the three are where most violations live." },
          ],
          include: [
        ...
        },
        {
          ...
          walkthrough: [
            { step: "Personal information", detail: "Names, addresses, employers, phone numbers, date of birth, SSN. Any single item that is wrong, outdated, or unfamiliar gets logged for Phase 3 cleanup." },
            { step: "Account summary", detail: "Total open accounts, total balances, oldest account, most recent account. This is your snapshot, but the detail is below." },
            { step: "Open accounts", detail: "Each open trade line: creditor name, account number (usually last 4), open date, credit limit, current balance, payment history, status." },
            { step: "Closed accounts & collections", detail: "Closed with positive history (keep — these help you), closed with damage (potential dispute), and collections (Phase 2 / Phase 5 territory)." },
            { step: "Public records", detail: "Bankruptcies, civil judgments where still reported, tax liens. These follow their own removal rules." },
            { step: "Inquiries", detail: "Hard inquiries last 24 months on the report, 12 months in scoring. Soft inquiries are not your concern. Unauthorized hard inquiries become L19." },
          ],
        ...
        },
        {
          ...
          walkthrough: [
            { step: "Late payments on open accounts", detail: "30/60/90/120-day lates inside the last 7 years. Goodwill / Phase 4 dispute candidates depending on accuracy." },
            { step: "Charge-offs", detail: "Original creditor wrote the debt off but is still reporting the trade line. High-impact. Phase 5 territory." },
            { step: "Collections", detail: "Third-party collector is now reporting. Check the date of first delinquency — collections drop 7 years from that date, NOT the date the collector picked it up." },
            { step: "Repossessions / foreclosures", detail: "Often reported by both the original lender AND a downstream collector. Treat as two separate trade lines." },
            { step: "Public records", detail: "Most civil judgments and tax liens were removed by the bureaus in 2017–2018. Bankruptcies still report up to 10 years (Ch. 7) or 7 years (Ch. 13 from filing)." },
            { step: "Hard inquiries you didn't authorize", detail: "Any inquiry you cannot tie to a real application — L19." },
          ],
          example:
        ...
        },
        {
          ...
          walkthrough: [
            { step: "List every name variation", detail: "Maiden names, hyphenations, middle initial vs full name, Jr/Sr/III. Keep only the legal current version + any prior legal name documented by court order." },
            { step: "List every address", detail: "Compare to your actual residential history. Anything you have never lived at is a candidate for removal. Anything older than 10 years is also fair game." },
            { step: "List every employer", detail: "Employers do not move your score, but they show up during income verification and identity-mix disputes. Strip outdated and unfamiliar employers." },
            { step: "Verify SSN and DOB", detail: "If even one digit is off on any bureau, every later dispute can be \"unable to verify\" rejected. Fix this first with L10." },
            { step: "Note phone numbers", detail: "Old or unfamiliar numbers should come off — they are an identity-theft signal." },
          ],
          include: [
        ...
        },
        {
          ...
          walkthrough: [
            { step: "Tag every negative account with a lane", detail: "Identity (L05–L10), Validation (L01–L04), Bureau dispute (L11–L14), or Furnisher dispute (L15–L19)." },
            { step: "Open the Account Router (Strategy page)", detail: "It walks you through the four-question decision tree and tells you which lane to start in based on what dominates your file." },
            { step: "Open the Tracker", detail: "Log every account you intend to dispute now, before you mail anything. Sent dates, certified numbers, and outcomes all live here." },
            { step: "Set a 35-day cadence", detail: "FCRA gives bureaus 30 days to respond. Add 5 days for mail. Whatever you mail today, follow up day 35." },
          ],
    ...
    teaching: {
      ...
      modules: [
        ...
        },
        {
          ...
          walkthrough: [
            { step: "Within 30 days of first written contact", detail: "Federal law gives you a 30-day window to dispute and request validation in writing. The collector must then cease collection until validation is provided." },
            { step: "Any time you have never received the §1692g \"Mini-Miranda\" notice", detail: "If they started reporting or calling without sending the required initial notice, the window never properly opened." },
            { step: "When the account is fresh and unverified", detail: "If you genuinely do not recognize the debt, validation is the right first move." },
          ],
          exclude: [
        ...
        },
        {
          ...
          walkthrough: [
            { step: "Always certified mail, return receipt requested", detail: "USPS Form 3811 (the green card) is the legal proof of service. Without it, you have no admissible evidence the collector ever received your letter." },
            { step: "Keep the green card AND the tracking printout", detail: "Both belong in your tracker. Take a phone photo of the card the day it arrives in the mail." },
            { step: "Mail to the address on the collection notice — not the credit report", detail: "The notice address is the legally-served address. The bureau's address can be outdated by months." },
          ],
        },
        {
          eyebrow: "Module 05",
          ...
          walkthrough: [
            { step: "No response by day 31 → L02", detail: "Cite the silence, demand removal, and put them on notice that continued reporting after a defective validation request is itself an FCRA violation." },
            { step: "Inadequate paper → L03", detail: "They responded but the documents do not meet the bar. Reject on the record and demand actual chain-of-custody documents." },
            { step: "Errors identified → L04 + Phase 4", detail: "Their response surfaces inaccuracies (wrong DOFD, wrong amount, wrong name). Pivot from validation to a documented inaccuracy dispute." },
            { step: "Full proper validation → reassess", detail: "If they actually validate it cleanly, validation is exhausted. Move to Phase 4 / Phase 5 on a different angle (procedure, accuracy, inconsistencies) — or consider Pay-for-Delete (L18)." },
          ],
        },
      ],
    },
    ...
    teaching: {
      ...
      modules: [
        ...
        },
        {
          ...
          walkthrough: [
            { step: "Send L05 to each creditor that holds wrong data", detail: "Correct it at the source first. Otherwise the bureau cleans it up and the creditor immediately re-feeds the bad data on the next reporting cycle." },
            { step: "Send L06 to all three bureaus", detail: "One letter per bureau, listing every PI item you want removed or corrected. Be precise — quote the exact text on the report." },
            { step: "Wait 30 days, then audit", detail: "Pull a fresh report and confirm each item moved. If the bureau came back \"verified\" without explaining how, that is a §1681i violation." },
            { step: "Escalate with L07", detail: "Cite the §1681i investigation requirement and demand a real procedure response. Most non-investigations collapse at this stage." },
            { step: "Mixed file? Send L08", detail: "If you find someone else's name, address, or accounts intermingled with yours, separate immediately. Do not proceed to disputes while the file is mixed — you'll fix the wrong record." },
            { step: "Wrong SSN or DOB? Send L10", detail: "Anchor identity before any other phase moves. A wrong digit here invalidates every later verification request you make." },
          ],
        },
        {
          eyebrow: "Module 05",
          ...
          walkthrough: [
            { step: "Quote the bureau's exact text", detail: "\"On my report dated [date], in the Personal Information section, the following appears: 'JANE DOE, 4521 Mockingbird Ln, Houston TX'. This is inaccurate.\"" },
            { step: "State what should appear in its place — or that it should be removed entirely", detail: "Be specific. Do not write \"please update.\" Write \"please remove.\"" },
            { step: "Cite the statute briefly", detail: "Reference your §1681e(b) and §1681i rights to accurate, verifiable, and currently-investigated data." },
            { step: "Attach proof for any address change", detail: "ID + utility bill + lease. Bureaus reject undocumented PI updates." },
          ],
        ...
        },
        {
          ...
          walkthrough: [
            { step: "Mixed file (L08)", detail: "Two different real people's data ended up on one bureau file because of similar name, similar SSN, or shared address history. Remedy: separation, not fraud affidavit." },
            { step: "Identity theft", detail: "Someone fraudulently used your identity to open accounts. Remedy: IdentityTheft.gov FTC report, then bureau fraud blocks under §1681c-2 — that is automatic 4-business-day removal once the report is filed." },
          ],
        },
      ],
    },
      ...
      modules: [
        {
          ...
          walkthrough: [
            { step: "Mail by certified mail with return receipt", detail: "Same standard as Phase 2. The signature card is your proof the round started." },
            { step: "Day 1–30: bureau investigation window", detail: "FCRA §611(a)(1)(A) gives them 30 days. Plus 15 if you supply additional information after they open the investigation." },
            { step: "Day 31–35: response arrives", detail: "Read it carefully. Look for what they did NOT respond to as much as what they did." },
            { step: "Day 36+: escalate to next round", detail: "Do not wait. The bureaus count on you losing momentum." },
          ],
        },
        {
          eyebrow: "Module 02",
          ...
          walkthrough: [
            { step: "Round 1 — L11 — Accuracy dispute", detail: "Opens the investigation. State the inaccuracy specifically. Avoid vague \"this is wrong.\" Use \"the date of first delinquency reported is [X], but my records show [Y].\"" },
            { step: "Round 2 — L12 — Method of verification (MOV) demand", detail: "Now you ask HOW they verified. Under §1681i(6)(B), you have the right to know the source and procedure. Most bureaus cannot meet this bar." },
            { step: "Round 3 — L13 — Notice of intent to file complaint", detail: "Formal notice you will file with CFPB and your State AG. Bureaus track CFPB complaints — the threat is real." },
            { step: "Round 4 — L14 — Final violation notice", detail: "Last warning. Document every prior round and reference each one by certified-mail tracking number. This letter is also your evidence package for Phase 6." },
          ],
    ...
    teaching: {
      ...
      modules: [
        ...
        },
        {
          ...
          walkthrough: [
            { step: "L15A · Collection agency", detail: "When a third-party collector is the furnisher reporting the bad data." },
            { step: "L15B · Original creditor", detail: "When the bank, lender, or service provider is reporting the bad data themselves." },
            { step: "L16 · Inconsistency attack", detail: "When the same account reports three different versions across the three bureaus. Use the worst version as your evidence against the others." },
            { step: "L17 · Charge-off violations", detail: "Re-aging, balance changes after charge-off, status flips. Charge-offs are supposed to be frozen — every change after the charge-off date is a separate FCRA violation." },
            { step: "L18 · Pay-for-Delete", detail: "Last resort when validation and disputes have failed. Always in writing, never by phone, never partial." },
            { step: "L19 · Unauthorized hard inquiry removal", detail: "Hard inquiries you cannot tie to an application you submitted are §1681b violations." },
          ],
        },
      ],
    },
      ...
      modules: [
        {
          ...
          walkthrough: [
            { step: "Open consumerfinance.gov/complaint", detail: "Choose \"Credit reporting, credit repair services, or other personal consumer reports.\"" },
            { step: "Identify the company", detail: "File against the bureau, the furnisher, or both — separate complaints if both are at fault." },
            { step: "Describe what happened", detail: "Use dates, certified-mail tracking numbers, and the exact violation. Avoid emotion. Stick to the timeline." },
            { step: "Attach evidence", detail: "Your letters, their responses, your green cards, your tracker export." },
            { step: "Choose desired resolution", detail: "Removal of the item — not money. Money is for the lawyer phase." },
            { step: "Submit and save the complaint number", detail: "The bureau has 15 days to respond on the public record." },
          ],
        },
        {
          eyebrow: "Module 02",
